...
class Uri
{
  ...
  {
    return ($this->hasScheme()) ? new Str($this->scheme) : $default;
  }
  ...
  {
    return ($this->hasUser()) ? new Str(urldecode($this->user)) : $default;
  }
  ...
  {
    return ($this->hasPass()) ? new Str(urldecode($this->pass)) : $default;
  }
  ...
  {
    return ($this->hasHost()) ? new Str(rawurldecode($this->host)) : $default;
  }
  ...
  {
    return ($this->hasPath()) ? new Str(rawurldecode($this->path)) : $default;
  }
  ...
  {
    return ($this->hasFragment()) ? new Str(rawurldecode($this->fragment)) : $default;
  }
  ...
  {
    $scriptPath = new Str(dirname(self::getHostParam("SCRIPT_NAME")));

...
{
  /**
   * Stores an array of data parsed from Node objects.
   *
   * @var array
   */
  protected $data = null;
  ...
  /**
   * The Node object which is currently processed.
   *
   * @var Node
   */
  ...
  /**
   * An array filled with siblings for the Node object which is currently
   * processed.
   *
   * @var array
   */
  ...
  /**
   * An internal counter indicating the depth of the Node object previously
   * processed.
   *
   * @var integer
   */
   ...
   * @return void
   */
  public function fetchObject(Node $node, array $siblings = array())
  {
    $this->currObj = $node;

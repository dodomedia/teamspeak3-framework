...
class Reply
{
  ...
  /**
   * Returns the reply as an Str object.
   *
   * @return Str
   */
  ...
  /**
   * Parses a ServerQuery error and throws a Exception object if
   * there's an error.
   *
   * @param  string $err
   * @throws Exception
  ...
  protected function fetchReply($rpl)
  {
    ...
    $this->rpl = new Str(implode(TeamSpeak3::SEPARATOR_LIST, $rpl));
  }
}
